...
export default function SOP3KPIs() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#080C14] via-[#0F1419] to-[#080C14] p-6 lg:p-8">
      <div className="max-w-5xl mx-auto">
        <motion.button
          onClick={() => navigate('/sop3-control-material')}
        ...
        >
          <ArrowLeft size={20} />
          <span>Volver a SOP 3-Control de materiales para proyecto</span>
        </motion.button>
        ...
        >
          <h1 className="text-3xl font-bold mb-2">
            <span className="bg-gradient-to-r from-orange-500 to-red-600 bg-clip-text text-transparent">
              SOP 3-Control de materiales para proyecto - KPI's
            </span>
          </h1>
        </motion.div>
